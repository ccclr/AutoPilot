    ...
    match matches.subcommand() {
        ...
        ("primary", _) => {
            ...
            Primary::spawn(
                ...
                /* _tx_consensus */ tx_new_certificates,
                /* _tx_committer */ tx_committer,
                /* rx_committer */ rx_committer,
                /* rx_consensus */ rx_feedback,
                /* _tx_sailfish */ tx_sailfish,
                /* _rx_pushdown_cert */ rx_pushdown_cert,
        ...
        ("worker", Some(sub_matches)) => {
            ...
            Worker::spawn(
                ...
                parameters,
                store,
                parameters_file.map(|s| s.to_string()),
            );
        }
        _ => unreachable!(),
    }
