...
class CommandMaker:
    ...
    @staticmethod
    def run_metrics_collector(epoch_slots, window_size, node_index=None, repo_name=None, log_dir=None, parameters_file=None):
        ...
        cmd = f'RUST_STATE_SOCKET_PATH={socket_path} python3 {metrics_collector_path}'
    ...
    @staticmethod
    def run_controller(node_index=None, repo_name=None, log_dir=None, parameters_file=None):
